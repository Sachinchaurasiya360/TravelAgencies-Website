...
async function getDashboardData() {
  ...
  return {
    ...
    upcomingDutySlips: upcomingDutySlips.map((ds) => ({
      ...
      pickupTime: ds.booking.pickupTime,
      baseFare: ds.booking.baseFare?.toString() ?? null,
      tollCharges: ds.booking.tollCharges?.toString() ?? null,
      parkingCharges: ds.booking.parkingCharges?.toString() ?? null,
      driverAllowance: ds.booking.driverAllowance?.toString() ?? null,
      extraCharges: ds.booking.extraCharges?.toString() ?? null,
      extraChargesNote: ds.booking.extraChargesNote,
      discount: ds.booking.discount?.toString() ?? null,
      totalAmount: ds.booking.totalAmount?.toString() ?? null,
      customerName: ds.booking.customer.name,
      customerPhone: ds.booking.customer.phone,
    })),
  };
}
