          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="mt-5 flex items-center gap-3">
              ...
              <a
                href="#"
                aria-label="Facebook"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-gray-800 text-gray-400 transition-colors hover:bg-orange-500 hover:text-white"
              >
      ...
      <div className="border-t border-gray-800">
        <div className="container mx-auto px-4 py-5">
          <p className="text-center text-sm text-gray-500">
            &copy; 2026 Sarthak Tour and Travels. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
